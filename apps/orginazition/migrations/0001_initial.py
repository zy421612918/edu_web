# -*- coding: utf-8 -*-
# Generated by Django 1.9 on 2018-05-25 03:13
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('city', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='orginazition.CityDict', verbose_name='\u6240\u5728\u57ce\u5e02')),
            ],
            options={
                'verbose_name': '\u673a\u6784\u4fe1\u606f',
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('fav_nums', models.IntegerField(default=0, verbose_name='\u6536\u85cf\u6570\u91cf')),
                ('add_time', models.DateTimeField(default=datetime.datetime.now, verbose_name='\u6dfb\u52a0\u65f6\u95f4')),
                ('org', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='orginazition.CourseOrg', verbose_name='\u6240\u5c5e\u673a\u6784')),
            ],
            options={
                'verbose_name': '\u6559\u5e08\u4fe1\u606f',
